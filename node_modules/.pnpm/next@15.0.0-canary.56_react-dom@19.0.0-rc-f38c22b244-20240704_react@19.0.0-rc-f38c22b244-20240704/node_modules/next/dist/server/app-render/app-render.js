...
async function ReactServerError({ tree, ctx, errorType }) {
    const { getDynamicParamFromSegment, query, appUsingSizeAdjustment, componentMod: { AppRouter, GlobalError, createDynamicallyTrackedSearchParams }, requestStore: { url }, requestId } = ctx;
...
async function renderToHTMLOrFlightImpl(req, res, pagePath, query, renderOpts, baseCtx, requestEndedState) {
   ...
   * request.
   */ const shouldProvideFlightRouterState = isRSCRequest && (!isPrefetchRSCRequest || !isRoutePPREnabled);
    ...
    const renderToStream = (0, _tracer.getTracer)().wrap(_constants.AppRenderSpan.getBodyResult, {
        ...
        if (typeof renderOpts.postponed === 'string') {
            try {
                ...
                postponed = _staticrenderer.DYNAMIC_DATA;
            }
        }
           ...
           */ // First we check if we have any dynamic holes in our HTML prerender
                if ((0, _dynamicrendering.usedDynamicAPIs)(prerenderState)) {
                    if (result.postponed != null) {
                        ...
                        metadata.postponed = JSON.stringify((0, _staticrenderer.getDynamicHTMLPostponedState)(result.postponed));
                    } else {
                    ...
                    return {
                        stream: await (0, _nodewebstreamshelper.continueDynamicPrerender)(result.stream, {
                    ...
                    if ((0, _dynamicrendering.usedDynamicAPIs)(prerenderState)) {
                        ...
                        if (result.postponed != null) {
                            ...
                            const resumeRenderer = (0, _staticrenderer.createStaticRenderer)({
                                ...
                                postponed: (0, _staticrenderer.getDynamicHTMLPostponedState)(result.postponed),
                                streamOptions: {
                            ...
                            renderedHTMLStream = (0, _nodewebstreamshelper.chainStreams)(result.stream, resumeStream);
                        }
                        return {
                ...
                if (result.resumed) {
                    ...
                    return {
                        stream: await (0, _nodewebstreamshelper.continueDynamicHTMLResume)(result.stream, {
                            inlinedDataStream,
                            getServerInsertedHTML
                        })
                    };
                    ...
                    return {
                        stream: await (0, _nodewebstreamshelper.continueDynamicDataResume)(result.stream, {
                            inlinedDataStream
                        })
                    };
                }
                ...
                return {
                    stream: await (0, _nodewebstreamshelper.continueFizzStream)(result.stream, {
                        inlinedDataStream: (0, _useflightresponse.createInlinedDataReadableStream)(dataStream, nonce, formState),
