 ...
 */ function InnerLayoutRouter(param) {
    ...
    if (!resolvedRsc) {
       ...
       */ // TODO-APP: remove ''
            ...
            childNode.lazyData = lazyData = fetchServerResponse(new URL(url, location.origin), refetchTree, includeNextUrl ? context.nextUrl : null, buildId).then((serverResponse)=>{
                startTransition(()=>{
