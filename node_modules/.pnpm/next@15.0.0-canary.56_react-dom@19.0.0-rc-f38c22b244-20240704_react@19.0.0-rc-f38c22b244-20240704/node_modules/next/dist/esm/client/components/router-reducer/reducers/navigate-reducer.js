    ...
    return data.then((param)=>{
        ...
        for (const flightDataPath of flightData){
            ...
            if (newTree !== null) {
                ...
                let applied = false;
                if (prefetchValues.status === PrefetchCacheEntryStatus.stale && !mutable.onlyHashChange && !isFirstRead) {
        ...
        for (const flightDataPath of flightData){
            ...
            if (newTree !== null) {
                ...
                flightDataPath.length === 4) {
                    ...
                    const task = updateCacheNodeOnNavigation(currentCache, currentTree, prefetchedTree, seedData, head, layerAssets);
