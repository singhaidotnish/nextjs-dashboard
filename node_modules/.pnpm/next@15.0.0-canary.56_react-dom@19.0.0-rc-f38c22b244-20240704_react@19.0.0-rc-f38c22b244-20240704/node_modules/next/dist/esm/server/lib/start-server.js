...
let startServerSpan;
export async function getRequestHandlers({ dir, port, isDev, server, hostname, minimalMode, keepAliveTimeout, experimentalHttpsServer, quiet }) {
    return initialize({
        dir,
        port,
        hostname,
...
export async function startServer(serverOptions) {
    ...
    process.title = `next-server (v${"15.0.0-canary.56"})`;
    let handlersReady = ()=>{};
    let handlersError = ()=>{};
