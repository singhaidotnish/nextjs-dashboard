...
import { AssetMapper, formatIssue, getTurbopackJsConfig, handleEntrypoints, handlePagesErrorRoute, handleRouteType, hasEntrypointForKey, msToNs, processIssues, renderStyledStringToErrorAnsi, processTopLevelIssues, isWellKnownError, printNonFatalIssue, normalizedPageToTurbopackStructureRoute } from './turbopack-utils';
    ...
    const hotReloader = {
        ...
        appPaths, definition, isApp, url: requestUrl }) {
            ...
            try {
                ...
                /* eslint-disable-next-line @typescript-eslint/no-shadow -- intentionally shadowed*/ for (const page of pages){
                    const normalizedAppPage = normalizedPageToTurbopackStructureRoute(page, extname(routeDef.filename));
