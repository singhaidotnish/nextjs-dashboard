...
async function build(dir, reactProductionProfiling = false, debugOutput = false, runLint = true, noMangling = false, appDirOnly = false, turboNextBuild = false, experimentalBuildMode, traceUploadUrl) {
    ...
    try {
        ...
        await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            await (0, _builddiagnostics.recordFrameworkVersion)("15.0.0-canary.56");
            ...
            let pagesPaths = providedPagePaths.length > 0 ? providedPagePaths : !appDirOnly && pagesDir ? await nextBuildSpan.traceChild('collect-pages').traceAsyncFn(()=>(0, _recursivereaddir.recursiveReadDir)(pagesDir, {
            ...
            if (appDir) {
                ...
                let appPaths = providedAppPaths.length > 0 ? providedAppPaths : await nextBuildSpan.traceChild('collect-app-paths').traceAsyncFn(()=>(0, _recursivereaddir.recursiveReadDir)(appDir, {
